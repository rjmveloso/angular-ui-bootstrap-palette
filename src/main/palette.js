		...
		'<div class="palette">\
		   <div class="col-md-4 palette-options">\
		     <div class="form-group">\
		       <label for="{{::optid}}">{{$ctrl.optionsLabel}}</label>\
		       <select id="{{::selid}}" multiple ng-model="$ctrl.optmodel" ng-disabled="$ctrl.disabled"\
		   ...
		   <div class="col-md-4 palette-selected">\
	         <div class="form-group">\
		       <label for="{{::selid}}">{{$ctrl.selectedLabel}}</label>\
